...
public class SfntTool {
  ...
  public static void subset(String input, String output, String content) throws IOException {
    SfntTool tool = new SfntTool();
    tool.woff = false;
    tool.subsetString = content;
    File fontFile = new File(input);
    File outputFile = new File(output);
    tool.subsetFontFile(fontFile, outputFile, 1);
  }
